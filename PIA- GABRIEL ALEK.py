...
def Crear_tabla():
    ...
    try:
        ...
        with sqlite3.connect("CoworkingLTI") as conn:
            ...
            cursor.execute("CREATE TABLE IF NOT EXISTS Salas(clave INTEGER PRIMARY KEY,nombre TEXT NOT NULL, capacidad INTEGER NOT NULL);")
        ...
        print (f"Se produjo el siguiente error: {sys.exc.info()[0]}")
    ...
    while True:
        ...
        try:
            ...
            with sqlite3.connect("CoworkingLTI") as conn:
                ...
                cursor.execute("SELECT * FROM Usuarios WHERE clave = :clave", valores)
                ...
                if registro:
                    ...
                    for clave, nombre in registro:
                        ...
                        print(f"No se encontro un proyecto asociado a la clave {valor_clave}")
            ...
            Nombre = input("Ingresa el nombre de la reservacion(Escribe SALIR para regresar al menú): ")
            ...
            if Nombre == '':
                ...
                Fecha_Ingresada = input("Ingresa la fecha de reservacion: ")
                ...
                if Fecha_dt < fecha_permitida:
                    ...
                    print("Debes hacer la reservacion con 2 dias de anticipacion.")
                    ...
                    try:
                        ...
                        with sqlite3.connect("CoworkingLTI") as conn:
                            ...
                            cursor.execute("INSERT INTO Reservaciones VALUES(:folio,:nombre,:horario,:fecha)",Miami)
                        ...
                        if (conn):
                            ...
                            print("¡Reservacion Realizada con existo!")
                            ...
                            try:
                                ...
                                with sqlite3.connect("CoworkingLTI", detect_types = sqlite3.PARSE_DECLTYPES / sqlite3.PARSE_COLNAMES) as conn:
                                    ...
                                    cursor.execute("SELECT folio, nombre, horario, fecha FROM Reservaciones WHERE DATE(fecha) = (:fecha);", criterios)

                                    #mi_cursor.execute("SELECT clave, nombre, fecha_registro FROM Amigo WHERE DATE(fecha_registro) >= :fecha;", criterios)

                                    registros = cursor.fetchell()
                                    ...
                                    for clave, nombre, fecha_registro, fecha in registros:
                                        ...
                                        print("{clave}\t {nombre}\t {fecha_registro}\t {fecha}\t")
                                ...
                                print(f"Se produjo el siguiente error: {sys.exe_info()[0]}")
...
def consulta_fecha():
    ...
    fecha_consultar = input("Dime una fe ha (dd/mm/aaaa: )")
    ...
    try:
        ...
        with sqlite3.connect("CoworkingLTI", detect_types = sqlite3.PARSE_DECLTYPES / sqlite3.PARSE_COLNAMES) as conn:
            ...
            for folio, nombre, horario, fecha in registros:
                ...
                print(f'Estas fechas estan ocupadas {fecha.date}')
    ...
    while True:
        ...
        try:
            ...
            with sqlite3. connect ("CoworkingLTI", detect_types = sqlite3.PARSE_DECLTYPES | sqlite3. PARSE_COLNAMES) as conn:
                ...
                cursor.execute ("SELECT folio, nombre, horario, fecha FROM Reservaciones WHERE fecha = «fecha", criterios)
                ...
                if fecha_dt < fecha_permitida:
                    ...
                    try:
                        ...
                        with sqlite3.connect ("CoworkingLTI") as conn:
                            ...
                            #delete={"folio" :id sala, "nombre": Name, "horario": Turno, "fecha": fecha_dt}
...
def Mi_menu():
    ...
    while True:
        ...
        try:
            ...
            Opcion = int(input ("Seleccione el numero de la accion que quiere realizar \(n:"))
            ...
            if Opcion == 1:
                ...
                print ("Eso no esta disponible checa el menù")
